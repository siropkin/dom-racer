...
export const POLICE = {
  START_DELAY_MS: 12_000,
  START_SCORE_THRESHOLD: 30,
  START_COINS_THRESHOLD: 6,
  INITIAL_SPAWN_MIN_MS: 10_000,
  INITIAL_SPAWN_MAX_MS: 15_000,
  RESPAWN_MIN_MS: 11_000,
  RESPAWN_MAX_MS: 17_000,
  POST_SPAWN_MIN_MS: 14_000,
  POST_SPAWN_MAX_MS: 20_000,
  CHASE_DURATION_MIN_MS: 5_600,
  CHASE_DURATION_MAX_MS: 7_800,
...
export const PLANE = {
  ...
  RESPAWN_MIN_MS: 17_000,
  RESPAWN_MAX_MS: 25_000,
  BONUS_PICKUP_SIZE: 20,
  COIN_TRAIL_CHANCE: 0.36,
  COIN_TRAIL_DURATION_MS: 3_200,
...
export const PLAYER = {
  ...
  ICE_DRIFT_INPUT_INFLUENCE: 0.2,
  ICE_DRIFT_ACCELERATION: 26,
} as const;
