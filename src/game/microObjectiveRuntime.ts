...
const OBJECTIVE_INITIAL_DELAY_MIN_MS = OBJECTIVES.INITIAL_DELAY_MIN_MS;
const OBJECTIVE_INITIAL_DELAY_MAX_MS = OBJECTIVES.INITIAL_DELAY_MAX_MS;
const OBJECTIVE_COMPLETE_DELAY_MIN_MS = OBJECTIVES.COMPLETE_DELAY_MIN_MS;
const OBJECTIVE_COMPLETE_DELAY_MAX_MS = OBJECTIVES.COMPLETE_DELAY_MAX_MS;
const OBJECTIVE_EXPIRE_DELAY_MIN_MS = OBJECTIVES.EXPIRE_DELAY_MIN_MS;
const OBJECTIVE_EXPIRE_DELAY_MAX_MS = OBJECTIVES.EXPIRE_DELAY_MAX_MS;
